...
('Apolo', 33, 1), ('Artemis', 33, 2), ('Spuntik', 33, 1), ('SkyLab', 33, 3), ('Naves', 33, 2),  
('Cosmos', 33, 2), ('Auditorio', 45, 5), ('Salón Azul', 33, 3), ('Aula 101', 33, 1), ('Aula 102', 33, 2),  
('Aula 103', 33, 3), ('Aula 104', 33, 4), ('Aula 105', 20, 5), ('Aula 106', 20, 6), ('Aula 107', 20, 7),  
...
INSERT INTO sgdb_route(id_route, id_Main_SGBD, id_Second_SGBD) VALUES
(1, 3, 1), (2, 1, 2), (3, 2, 3), (4, 1, 6), (5, 15, 19),(6, 2, 14), (7, 9, 17), (8, 4, 23), (9, 7, 20), (10, 11, 16), (11, 13, 21), (12, 18, 24), (13, 1, 9), (14, 3, 10), (15, 6, 14),
(16, 2, 5), (17, 8, 12), (18, 4, 16), (19, 7, 11), (20, 17, 22),
(21, 19, 23), (22, 15, 21), (23, 13, 20), (24, 18, 24), (25, 1, 7),
(26, 3, 9), (27, 6, 13), (28, 10, 18), (29, 2, 16), (30, 4, 19),
(31, 5, 20), (32, 8, 21), (33, 11, 23), (34, 14, 24), (35, 7, 22),
(36, 12, 15), (37, 17, 18), (38, 9, 13), (39, 16, 19), (40, 6, 21),
(41, 2, 23), (42, 4, 12), (43, 11, 14), (44, 5, 10), (45, 3, 8),
(46, 7, 15), (47, 9, 17), (48, 1, 22), (49, 13, 24), (50, 18, 20);
...
INSERT INTO skill_planned(id_skill, start_date, end_date, id_state_skill, id_route) VALUES 
(1, '2023-01-08', '2023-03-30', 3, 1),
(2, '2023-02-01', '2023-04-15', 2, 2),
(3, '2023-02-10', '2023-05-20', 1, 3),
(4, '2023-03-01', '2023-06-10', 3, 1),
(5, '2023-03-15', '2023-07-01', 2, 2),
(6, '2023-04-01', '2023-07-30', 1, 3),
(7, '2023-04-10', '2023-08-15', 3, 1),
(8, '2023-05-05', '2023-09-10', 2, 2),
(9, '2023-05-20', '2023-09-30', 1, 3),
(10, '2023-06-01', '2023-10-15', 3, 1),
(11, '2023-06-10', '2023-11-01', 2, 2),
(12, '2023-07-01', '2023-11-20', 1, 3),
(13, '2023-07-15', '2023-12-05', 3, 1),
(14, '2023-08-01', '2023-12-20', 2, 2),
(15, '2023-08-10', '2024-01-10', 1, 3),
(16, '2023-09-01', '2024-01-30', 3, 1),
(17, '2023-09-15', '2024-02-15', 2, 2),
(18, '2023-10-01', '2024-03-01', 1, 3),
(19, '2023-10-10', '2024-03-15', 3, 1),
(20, '2023-11-01', '2024-04-01', 2, 2),
(21, '2023-11-15', '2024-04-20', 1, 3),
(22, '2023-12-01', '2024-05-01', 3, 1),
(23, '2023-12-10', '2024-05-15', 2, 2),
(24, '2024-01-01', '2024-06-01', 1, 3),
(25, '2024-01-15', '2024-06-15', 3, 1),
(26, '2024-02-01', '2024-07-01', 2, 2),
(27, '2024-02-10', '2024-07-15', 1, 3),
(28, '2024-03-01', '2024-08-01', 3, 1),
(29, '2024-03-15', '2024-08-15', 2, 2),
(30, '2024-04-01', '2024-09-01', 1, 3),
(31, '2024-04-10', '2024-09-15', 3, 1),
(32, '2024-05-01', '2024-10-01', 2, 2),
(33, '2024-05-15', '2024-10-15', 1, 3),
(34, '2024-06-01', '2024-11-01', 3, 1),
(35, '2024-06-10', '2024-11-15', 2, 2),
(36, '2024-07-01', '2024-12-01', 1, 3),
(37, '2024-07-15', '2024-12-15', 3, 1),
(38, '2024-08-01', '2025-01-01', 2, 2),
(39, '2024-08-10', '2025-01-15', 1, 3),
(40, '2024-09-01', '2025-02-01', 3, 1),
(41, '2024-09-15', '2025-02-15', 2, 2),
(42, '2024-10-01', '2025-03-01', 1, 3),
(43, '2024-10-10', '2025-03-15', 3, 1),
(44, '2024-11-01', '2025-04-01', 2, 2),
(45, '2024-11-15', '2025-04-15', 1, 3),
(46, '2024-12-01', '2025-05-01', 3, 1),
(47, '2024-12-10', '2025-05-15', 2, 2),
(48, '2025-01-01', '2025-06-01', 1, 3),
(49, '2025-01-15', '2025-06-15', 3, 1),
(50, '2025-02-01', '2025-07-01', 2, 2);
...
('1052340502', 'Isabela', 'Galvis', '2023-03-05', 3, 4, 3, 3, 3),
...
('1052340509', 'Javier', 'Ríos', '2023-10-25', 1, 4, 2, 10, 1),
...
('1052340513', 'Nicolás', 'Delgado', '2024-02-05', 2, 4, 1, 14, 2),
('1052340514', 'Olga', 'Reyes', '2024-03-28', 3, 1, 3, 15, 3),
('1052340515', 'Pedro', 'Córdoba', '2024-04-20', 1, 4, 2, 16, 1),
('1052340516', 'Quintín', 'Moreno', '2024-05-09', 2, 2, 1, 17, 2),
('1052340517', 'Rosa', 'Navarro', '2024-06-30', 3, 1, 3, 18, 3),
('1052340518', 'Sergio', 'Álvarez', '2024-07-25', 1, 4, 2, 19, 1),
...
('100000003', 'Carlos', 'Rodríguez', '2023-03-10', 3, 3, 3, 3, NULL),
('100000004', 'Laura', 'Fernández', '2023-04-05', 1, 1, 1, 4, 1),
('100000005', 'Andrés', 'López', '2023-05-18', 2, 2, 2, 5, 2),
('100000006', 'Camila', 'Díaz', '2023-06-25', 3, 3, 3, 6, NULL),
('100000007', 'Felipe', 'Martínez', '2023-07-30', 1, 1, 1, 7, 1),
('100000008', 'Valentina', 'Torres', '2023-08-12', 2, 6, 2, 8, 2),
('100000009', 'Santiago', 'Ramírez', '2023-09-03', 3, 6, 3, 9, 3),
('100000010', 'Daniela', 'Castro', '2023-10-21', 1, 1, 1, 10, 1),
('100000011', 'Diego', 'Vargas', '2023-11-11', 2, 2, 2, 11, 2),
('100000012', 'Natalia', 'Jiménez', '2023-12-05', 3, 7, 3, 12, 3),
...
('100000016', 'Julián', 'Mendoza', '2024-04-14', 1, 7, 1, 16, 1),
...
('100000023', 'Fernanda', 'Salazar', '2024-11-17', 2, 5, 2, 23, 2),
('100000024', 'Oscar', 'Cabrera', '2024-12-24', 3, 5, 3, 24, 3),
('100000025', 'Patricia', 'Galeano', '2025-01-05', 1, 5, 1, 25, 1),
('100000026', 'Hugo', 'Sarmiento', '2025-01-15', 2, 5, 2, 26, 2),
('100000027', 'Gloria', 'Quintero', '2025-02-03', 3, 5, 3, 27, 3),
('100000028', 'Jorge', 'Gutiérrez', '2025-02-18', 1, 5, 1, 28, 1),
('100000029', 'Eliana', 'Bermúdez', '2025-03-01', 2, 5, 2, 29, 2),
('100000030', 'Raúl', 'Pinto', '2025-03-15', 3, 5, 3, 30, 3),
('100000031', 'Diana', 'Reyes', '2025-03-28', 1, 5, 1, 31, 1),
('100000032', 'Mauricio', 'Escobar', '2025-03-30', 2, 5, 2, 32, 2),
('100000033', 'Liliana', 'Fuentes', '2025-03-31', 3, 5, 3, 33, 3),
('100000034', 'Pablo', 'Valencia', '2025-03-31', 1, 5, 1, 34, 1),
('100000035', 'Lucía', 'Hoyos', '2025-03-31', 2, 5, 2, 35, 2),
('100000036', 'Rodrigo', 'Ocampo', '2025-03-31', 3, 5, 3, 36, 3),
('100000037', 'Beatriz', 'Herrera', '2025-03-31', 1, 5, 1, 37, 1),
('100000038', 'Samuel', 'Perdomo', '2025-03-31', 2, 5, 2, 38, 2),
('100000039', 'Verónica', 'Tamayo', '2025-03-31', 3, 5, 3, 39, 3),
('100000040', 'Álvaro', 'Bautista', '2025-03-31', 1, 5, 1, 40, 1),
('100000041', 'Silvia', 'Medina', '2025-03-31', 2, 5, 2, 41, 2),
('100000042', 'René', 'Villalobos', '2025-03-31', 3, 5, 3, 42, 3),
('100000043', 'Adriana', 'Maldonado', '2025-03-31', 1, 5, 1, 43, 1),
('100000044', 'Cristian', 'Peña', '2025-03-31', 2, 5, 2, 44, 2),
('100000045', 'Mónica', 'Cardozo', '2025-03-31', 3, 5, 3, 45, 3),
('100000046', 'Fabián', 'Lara', '2025-03-31', 1, 5, 1, 46, 1),
('100000047', 'Lorena', 'Rico', '2025-03-31', 2, 5, 2, 47, 2),
('100000048', 'Javier', 'Soto', '2025-03-31', 3, 5, 3, 48, 3),
('100000049', 'Isabel', 'Guerrero', '2025-03-31', 1, 5, 1, 49, 1),
('100000050', 'Oscar', 'Mora', '2025-03-31', 2, 5, 2, 50, 2);
...
(1, 3), (2, 4), (3, 1), (4, 4), (5, 1), (6, 4), (7, 1), (8, 4), (9, 1), (10, 4),
(11, 3), (12, 4), (13, 1), (14, 4), (15, 1), (16, 4), (17, 3), (18, 4), (19, 1), (20, 4),
(21, 3), (22, 4), (23, 1), (24, 4), (25, 1), (26, 4), (27, 3), (28, 4), (29, 1), (30, 4),
(31, 3), (32, 4), (33, 1), (34, 4), (35, 1), (36, 4), (37, 3), (38, 4), (39, 1), (40, 4),
(41, 3), (42, 4), (43, 1), (44, 4), (45, 1), (46, 4), (47, 3);
